...
<body class="auth-page"><main class="auth-layout"><section class="auth-story">
    ...
    <div class="demo-roles"><div><strong>Admin</strong><span>admin / Admin@123</span></div><div><strong>Manager</strong><span>manager01 / Manager@123</span></div><div><strong>Employee</strong><span>employee01 / Employee@123</span></div></div>
